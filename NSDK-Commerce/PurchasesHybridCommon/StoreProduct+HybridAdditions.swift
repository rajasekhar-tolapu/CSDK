...
internal extension StoreProduct {
    ...
    static func rc_normalized(subscriptionPeriod: NSDK_Commerce.SubscriptionPeriod) -> String {
    ...
    static func rc_normalized(subscriptionPeriodUnit: NSDK_Commerce.SubscriptionPeriod.Unit) -> String {
