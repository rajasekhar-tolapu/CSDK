...
static RCUnityHelperDelegate *_RCUnityHelperShared(void) {
...
void _RCRestorePurchases(void) {
    [_RCUnityHelperShared() restorePurchases];
}

void _RCSyncPurchases(void) {
...
void _RCSyncAttributesAndOfferingsIfNeeded(void) {
...
void _RCInvalidateCustomerInfoCache(void) {
    [_RCUnityHelperShared() invalidateCustomerInfoCache];
}

void _RCPresentCodeRedemptionSheet(void) {
...
void _RCCollectDeviceIdentifiers(void) {
